...
class AnswerQuestion (FunctionalTest):
    ...
    def test_answer(self):
        ...
        self.browser.find_element_by_id("userquestion_answerreason").send_keys("answerquestion user 4")
        #driver.find_element_by_css_selector("input.btn").click()        



	#self.browser.find_element_by_xpath("//table[@id='TabAnswers']/tbody/tr[2]/td[0]").click()
