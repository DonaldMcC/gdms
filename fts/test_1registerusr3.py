...
class TestRegisterPage (FunctionalTest):
    ...
    def test_put_values_in_register_form(self):    
        ...
        first_name.send_keys(USERS['USER3'])    
        
        last_name = self.browser.find_element_by_name("last_name")    
        last_name.send_keys(USERS['USER3'])    
        
        email = self.browser.find_element_by_name("email")    
        email.send_keys("user3@user.com")    
        ...
        verify_password.send_keys(USERS['PASSWORD3'])    
        ...
        self.assertIn('Welcome user3', body.text)
