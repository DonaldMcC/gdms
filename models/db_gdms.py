...
db.define_table('question',
                ...
                Field('plan_editor', 'list:reference auth_user', writable=False, label='Plan Editors', default=auth.user_id),
                ...
                Field('shared_editing', 'boolean', default=False, label='Allow shared editing'),
