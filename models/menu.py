...
response.menu = [
    ...
    ('Review', False, URL('review', 'index'),
     [('Locations', False, URL('location', 'index')),
      ...
      ('Issues', False, URL('review', 'index', args=['action', 'proposed', 'priority', 0])),
      ('Questions', False, URL('review', 'index', args=['quest', 'resolved', 'priority', 0])),
      ('Actions', False, URL('review', 'index', args=['action', 'agreed', 'priority', 0])),
      ('Proposals', False, URL('review', 'newindex', args=['action', 'proposed', 'priority', 0])),
    ...
    ('My NDS', False, URL('review', 'index', args=['action']),
     [('My Issues', False, URL('review', 'index', args=['issue', 'my'])),
      ...
      ('My Draft Items', False, URL('review', 'index', args=['quest', 'draft'])),
