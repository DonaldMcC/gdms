...
response.menu = [
    ...
    ('Review', False, URL('review', 'index'),
     [('Locations', False, URL('location', 'index')),
      ...
      ('Issues', False, URL('review', 'newindex', args=['action', 'proposed', 'priority', 0])),
    ...
    ('My NDS', False, URL('review', 'index', args=['action']),
     [('My Issues', False, URL('review', 'newindex', args=['issue', 'my'])),
      ...
      ('My Draft Items', False, URL('review', 'newindex', args=['quest', 'draft'])),
      ('My Actions', False, URL('review', 'newindex', args=['action', 'my'])),
      ('My Actions', False, URL('review', 'newindex', args=['drafts', 'my'])),
