...
db.define_table('website_parameters',
                ...
                Field('del_answers',  'boolean', default=False, label=T('Delete User Answer on Resolution - not used yet')),
                Field('self_resolve',  'boolean', default=True, label=T('Allow self resolved actions')),
                Field('self_answer',  'boolean', default=False, label=T('Allow self-answer questions')),
...
db.define_table('evt',
                ...
                Field('startdatetime', 'datetime', label='Start Date Time',
                      default=(request.utcnow + datetime.timedelta(days=10)), widget=bsdatetimepicker_widget()),
                ...
                Field('description', 'text'),
                Field('evt_shared', 'boolean', default=True, label='Shared Event', comment='Allows other users to link questions'),
